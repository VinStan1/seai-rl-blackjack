...
The highest observed final reward came from **SARSA** with `epsilon=1.0->0.05 linear (80%), alpha=0.01, gamma=1.0`. Its mean reward was **-0.05256** (approximate 95% CI -0.05439 to -0.05073), with a 43.06% win rate.
...
|---|---:|---|---:|---:|---:|
| Monte Carlo | 500,000 | `epsilon=0.3, gamma=1.0` | -0.05623 [-0.05730, -0.05516] | 43.10% | 4.88 s |
| Q-learning | 500,000 | `epsilon=1.0->0.05 linear (80%), alpha=0.01, gamma=1.0` | -0.05395 [-0.05544, -0.05246] | 42.94% | 3.71 s |
| SARSA | 500,000 | `epsilon=1.0->0.05 linear (80%), alpha=0.01, gamma=1.0` | -0.05256 [-0.05439, -0.05073] | 43.06% | 3.86 s |
...
|---|---:|---:|---|
| Monte Carlo - Q-learning | 10 | -0.00228 [-0.00426, -0.00030] | interval excludes zero |
| Monte Carlo - SARSA | 10 | -0.00367 [-0.00642, -0.00091] | interval excludes zero |
| Q-learning - SARSA | 10 | -0.00139 [-0.00358, 0.00080] | difference is inconclusive at this precision |
...
- Source summary: `results/sweeps/blackjack_finite_hi_lo_refined_grid_20260820T141441Z/summary.json`
