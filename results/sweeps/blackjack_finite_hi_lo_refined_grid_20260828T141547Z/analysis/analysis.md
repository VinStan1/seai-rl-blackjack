# Analysis: blackjack_finite_hi_lo_refined_grid

Environment variant: **finite_hi_lo**.

## Executive summary

The highest observed final reward came from **Q-learning** with `epsilon=1.0->0.05 linear (80%), alpha=0.01, gamma=1.0`. Its mean reward was **-0.05558** (approximate 95% CI -0.05677 to -0.05439), with a 42.90% win rate.
...
|---|---:|---|---:|---:|---:|
| Monte Carlo | 500,000 | `epsilon=0.3, gamma=1.0` | -0.06257 [-0.06378, -0.06135] | 42.86% | 5.65 s |
| Q-learning | 500,000 | `epsilon=1.0->0.05 linear (80%), alpha=0.01, gamma=1.0` | -0.05558 [-0.05677, -0.05439] | 42.90% | 3.87 s |
| SARSA | 500,000 | `epsilon=1.0->0.05 linear (80%), alpha=0.01, gamma=1.0` | -0.05588 [-0.05786, -0.05389] | 42.94% | 3.94 s |
...
|---|---:|---:|---|
| Monte Carlo - Q-learning | 10 | -0.00698 [-0.00854, -0.00543] | interval excludes zero |
| Monte Carlo - SARSA | 10 | -0.00669 [-0.00917, -0.00421] | interval excludes zero |
| Q-learning - SARSA | 10 | 0.00029 [-0.00160, 0.00218] | difference is inconclusive at this precision |
...
- Source summary: `results/sweeps/blackjack_finite_hi_lo_refined_grid_20260828T141547Z/summary.json`
