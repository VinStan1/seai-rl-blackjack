...
The highest observed final reward came from **Q-learning** with `epsilon=1.0->0.05 linear (80%), alpha=0.005, gamma=1.0`. Its mean reward was **-0.04269** (approximate 95% CI -0.04466 to -0.04071), with a 43.36% win rate.
...
|---|---:|---|---:|---:|---:|
| Monte Carlo | 500,000 | `epsilon=0.25, gamma=1.0` | -0.04590 [-0.04678, -0.04502] | 43.56% | 3.20 s |
| Q-learning | 500,000 | `epsilon=1.0->0.05 linear (80%), alpha=0.005, gamma=1.0` | -0.04269 [-0.04466, -0.04071] | 43.36% | 3.21 s |
| SARSA | 500,000 | `epsilon=1.0->0.05 linear (80%), alpha=0.01, gamma=1.0` | -0.04306 [-0.04418, -0.04195] | 43.35% | 3.18 s |
...
|---|---:|---:|---|
| Monte Carlo - Q-learning | 10 | -0.00321 [-0.00532, -0.00110] | interval excludes zero |
| Monte Carlo - SARSA | 10 | -0.00283 [-0.00416, -0.00150] | interval excludes zero |
| Q-learning - SARSA | 10 | 0.00038 [-0.00139, 0.00215] | difference is inconclusive at this precision |
...
- Source summary: `results/sweeps/blackjack_finite_hidden_refined_grid_20260820T141054Z/summary.json`
