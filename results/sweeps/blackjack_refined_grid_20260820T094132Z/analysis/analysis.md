...
The highest observed final reward came from **SARSA** with `epsilon=1.0->0.05 linear (80%), alpha=0.005, gamma=1.0`. Its mean reward was **-0.04429** (approximate 95% CI -0.04478 to -0.04381), with a 43.31% win rate.
...
|---|---:|---|---:|---:|---:|
| Monte Carlo | 500,000 | `epsilon=0.25, gamma=1.0` | -0.04647 [-0.04727, -0.04568] | 43.38% | 23.25 s |
| Q-learning | 500,000 | `epsilon=0.25, alpha=0.005, gamma=1.0` | -0.04546 [-0.04670, -0.04422] | 43.24% | 21.84 s |
| SARSA | 500,000 | `epsilon=1.0->0.05 linear (80%), alpha=0.005, gamma=1.0` | -0.04429 [-0.04478, -0.04381] | 43.31% | 21.28 s |

## Literature baseline

The **stick-on-17** policy hits below 17 and sticks on 17 or above. On the same 100,000 seeded evaluation episodes, its mean reward was **-0.07622** with a 41.06% win rate.
...
|---|---:|---:|---|
| Monte Carlo - Q-learning | 10 | -0.00101 [-0.00226, 0.00023] | difference is inconclusive at this precision |
| Monte Carlo - SARSA | 10 | -0.00218 [-0.00315, -0.00121] | interval excludes zero |
| Q-learning - SARSA | 10 | -0.00117 [-0.00281, 0.00047] | difference is inconclusive at this precision |
...
- Source summary: `results/sweeps/blackjack_refined_grid_20260820T094132Z/summary.json`
