# Analysis: blackjack_finite_hidden_selected_transfer

Environment variant: **finite_hidden**.

## Executive summary

The highest observed final reward came from **Q-learning** with `epsilon=0.3, alpha=0.005, gamma=1.0`. Its mean reward was **-0.04661** (approximate 95% CI -0.04821 to -0.04501), with a 43.19% win rate.
...
|---|---:|---|---:|---:|---:|
| Monte Carlo | 2,000,000 | `epsilon=0.25, gamma=1.0` | -0.04738 [-0.04789, -0.04687] | 43.38% | 14.34 s |
| Q-learning | 1,000,000 | `epsilon=0.3, alpha=0.005, gamma=1.0` | -0.04661 [-0.04821, -0.04501] | 43.19% | 6.27 s |
| SARSA | 1,000,000 | `epsilon=1.0->0.05 linear (80%), alpha=0.005, gamma=1.0` | -0.04666 [-0.04746, -0.04586] | 43.10% | 6.33 s |
...
|---|---:|---:|---|
| Monte Carlo - Q-learning | 10 | -0.00077 [-0.00270, 0.00116] | difference is inconclusive at this precision |
| Monte Carlo - SARSA | 10 | -0.00072 [-0.00174, 0.00030] | difference is inconclusive at this precision |
| Q-learning - SARSA | 10 | 0.00005 [-0.00190, 0.00200] | difference is inconclusive at this precision |
...
- Source summary: `results/final/blackjack_finite_hidden_selected_transfer_20260828T135125Z/summary.json`
