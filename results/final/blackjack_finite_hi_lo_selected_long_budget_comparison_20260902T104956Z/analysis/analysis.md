...
The highest observed final reward came from **Q-learning** with `epsilon=1.0->0.05 linear (80%), alpha=0.01, gamma=1.0`. Its mean reward was **-0.04918** (approximate 95% CI -0.05059 to -0.04777), with a 43.03% win rate.
...
|---|---:|---|---:|---:|---:|
| Monte Carlo | 2,000,000 | `epsilon=0.3, gamma=1.0` | -0.05238 [-0.05347, -0.05128] | 43.22% | 17.34 s |
| Q-learning | 2,000,000 | `epsilon=1.0->0.05 linear (80%), alpha=0.01, gamma=1.0` | -0.04918 [-0.05059, -0.04777] | 43.03% | 15.86 s |
| SARSA | 2,000,000 | `epsilon=1.0->0.05 linear (80%), alpha=0.01, gamma=1.0` | -0.04922 [-0.05032, -0.04812] | 43.08% | 16.00 s |
...
|---|---:|---:|---|
| Monte Carlo - Q-learning | 10 | -0.00320 [-0.00513, -0.00126] | interval excludes zero |
| Monte Carlo - SARSA | 10 | -0.00316 [-0.00492, -0.00140] | interval excludes zero |
| Q-learning - SARSA | 10 | 0.00004 [-0.00163, 0.00171] | difference is inconclusive at this precision |
...
- Source summary: `results/final/blackjack_finite_hi_lo_selected_long_budget_comparison_20260902T104956Z/summary.json`
