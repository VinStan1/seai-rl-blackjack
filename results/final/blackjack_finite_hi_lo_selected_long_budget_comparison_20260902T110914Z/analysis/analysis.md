...
The highest observed final reward came from **SARSA** with `epsilon=1.0->0.05 linear (80%), alpha=0.01, gamma=1.0`. Its mean reward was **-0.04571** (approximate 95% CI -0.04696 to -0.04446), with a 43.19% win rate.
...
|---|---:|---|---:|---:|---:|
| Monte Carlo | 10,000,000 | `epsilon=0.3, gamma=1.0` | -0.04867 [-0.04971, -0.04762] | 43.31% | 96.85 s |
| Q-learning | 10,000,000 | `epsilon=1.0->0.05 linear (80%), alpha=0.01, gamma=1.0` | -0.04589 [-0.04693, -0.04486] | 43.17% | 73.26 s |
| SARSA | 10,000,000 | `epsilon=1.0->0.05 linear (80%), alpha=0.01, gamma=1.0` | -0.04571 [-0.04696, -0.04446] | 43.19% | 76.15 s |
...
|---|---:|---:|---|
| Monte Carlo - Q-learning | 10 | -0.00277 [-0.00409, -0.00145] | interval excludes zero |
| Monte Carlo - SARSA | 10 | -0.00296 [-0.00471, -0.00120] | interval excludes zero |
| Q-learning - SARSA | 10 | -0.00018 [-0.00201, 0.00164] | difference is inconclusive at this precision |
...
### 10,000,000 training episodes

![Performance versus training time at 10,000,000 episodes](performance_vs_training_time_10000000.png)
...
- Source summary: `results/final/blackjack_finite_hi_lo_selected_long_budget_comparison_20260902T110914Z/summary.json`
